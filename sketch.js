// 第一個角色（資料夾 `1/all.png`，8 幀）
let sprite1;
const FRAME_COUNT1 = 8;
let currentFrame1 = 0;
let lastFrameTime1 = 0;
let frameW1 = 0, frameH1 = 0;
const SCALE1 = 2;

// 第二個角色（資料夾 `2/all.png`，6 幀）
let sprite2;
const FRAME_COUNT2 = 6;
let currentFrame2 = 0;
let lastFrameTime2 = 0;
let frameW2 = 0, frameH2 = 0;
const SCALE2 = 2;

const FRAME_INTERVAL = 100; // ms per frame (10 FPS)
...
function setup() {
  ...
  if (sprite1) {
    // 硬編碼：1/all.png 尺寸為 422×74（8 幀）
    frameW1 = 490 / FRAME_COUNT1;
    frameH1 = 74;
  }
  if (sprite2) {
